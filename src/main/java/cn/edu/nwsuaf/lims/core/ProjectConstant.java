...
public final class ProjectConstant {
    public static final String BASE_PACKAGE = "cn.edu.nwsuaf.lims";//生成代码所在的基础包名称，可根据自己公司的项目修改（注意：这个配置修改之后需要手工修改src目录项目默认的包路径，使其保持一致，不然会找不到类）
    ...
    public static final String PUB_KEY="abcd1234abcd1234";
    public static final String SCRECT_KEY ="123456";
}
